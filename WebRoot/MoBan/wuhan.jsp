...
<div class="soufunsearch110615" style="margin-top: 40px; margin-bottom: 40px;">
    <div class="soufunsearch110615logo" id="dsy_B01_29">
		...
		<strong>集美大学</strong> <span class="zilink">[<a href="<%=path %>/index.jsp"  rel="nofollow">切换</a>]</span>		
		</div>
    </div>
</div>
...
<script type="text/javascript">initLoginWindowDetail();</script>
    ...
    <div class="wid1000">
        ...
        <div class="guide" id="rentid_83">
            <a href="http://www.fang.com/" target="_blank" rel="nofollow" >搜房网</a> &gt; <a href="http://zu.xiangyang.fang.com/" target="_blank" >集美大学租房</a>
        </div>
        <!--guide end-->
        <!-- searchlink start -->
       ...
       <div class="quxian mt15 ml25" id="rentid_47">
                    ...
                    <p class="qxName">
        <input type="radio" value="武昌区" class="org bold" name="house.area"/>万达附近
        <input type="radio" value="洪山区" class="org bold" name="house.area"/>嘉庚附近
