		...
		<div class="soufunsearch110615"
			...
			<div class="soufunsearch110615logo" id="dsy_B01_29">
				...
				<div class="soufunsearch110615city">
					<strong>华侨大学</strong> <span class="zilink">[<a
				...
				<div>
					<ul class="info ml25">
						<li id="Li1">区域： <input type="radio" value="集美区"
							class="org bold" name="house.area" />紫荆 <input type="radio"
							value="思明区" class="org bold" name="house.area" />凤凰 <input
							type="radio" value="湖里区" class="org bold" name="house.area" />梅院
